...
# Save as Fasta
Fas <- file(paste0(out.dir, "plant.fasta"))
...
write.table(data.frame("ID"=rownames(OTUs),OTUs),paste0(out.dir, "plant_OTUs.txt"), row.names=FALSE, sep = "\t")
